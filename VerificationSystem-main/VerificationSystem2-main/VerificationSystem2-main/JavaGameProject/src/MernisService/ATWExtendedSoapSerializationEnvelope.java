...
public class ATWExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(ATWDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new ATWStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static ATWDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static ATWDateTimeConverter dateTimeConverter = new ATWStandardDateTimeConverter();

    public ATWExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public ATWExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new ATWMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=ATWHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,ATWExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=ATWHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
