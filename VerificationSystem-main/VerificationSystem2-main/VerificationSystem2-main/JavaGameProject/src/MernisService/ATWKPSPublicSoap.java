...
public class ATWKPSPublicSoap
{
    ...
    public ATWKPSPublicSoap(){}

    public ATWKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public ATWKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        ATWExtendedSoapSerializationEnvelope envelope= new ATWExtendedSoapSerializationEnvelope(ATWExtendedSoapSerializationEnvelope.VER11);
