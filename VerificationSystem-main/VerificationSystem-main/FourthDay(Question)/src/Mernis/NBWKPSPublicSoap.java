...
public class NBWKPSPublicSoap
{
    ...
    public NBWKPSPublicSoap(){}

    public NBWKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public NBWKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        NBWExtendedSoapSerializationEnvelope envelope= new NBWExtendedSoapSerializationEnvelope(NBWExtendedSoapSerializationEnvelope.VER11);
